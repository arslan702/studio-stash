  ...
  return (
    <div>
        <div className={`w-full h-[259px] flex flex-col justify-center items-center bg-[${bg}] text-[#ffffff]`}>
            ...
            <div className='h-[45px] w-[148px] rounded-[42px] text-[#000000] pt-2 cursor-pointer' style={{background: 'linear-gradient(88.77deg, #CEAD64 2.99%, #ECE1A9 48.88%, #AF8C3D 99.08%)'}}>
