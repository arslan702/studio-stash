        ...
        <div className="flex flex-row flex-wrap justify-between items-start gap-5  md:grid-cols-3 sm:grid-cols-2 grid:cols-1 m-14">
          ...
          <div className="homehead border-[1px] border-[#CEAD64] rounded-[25px] h-[301px] w-[232px]">
            <div className="flex flex-col justify-center items-center pt-5 ">
              ...
              <center>
              <h4 className=" text-[33px] leading-[35px] align-center mt-1">
                Financial freedom{" "}
              </h4>
              </center>
              <p className="text-center px-2 text-[14px] leading-[28px] pt-3">
          ...
          <div className="homehead border-[1px] border-[#CEAD64] rounded-[25px] h-[301px] w-[232px]">
            <div className="flex flex-col justify-center items-center pt-5 ">
              ...
              <p className="text-center px-2 text-[14px] leading-[28px] pt-5">
